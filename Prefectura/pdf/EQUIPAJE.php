...
/*ESTO ES EL TITULO QUE ESTA EN EL DOCUMENTO QUE DICE QUE TIPO DE SOLICITUD ES*/
					   ...
					   $cabecera='<b>CONSTANCIA DE RESIDENCIA PARA REGIMEN DE EQUIPAJE (VEHICULO)';
					   $cabecera2='<b>F-PF-:01';
					   $fin='En'./**/', a los <b>'./*dia de impresion*/'<b>dias del mes de <b>'./*mes de impresion*/'</b> del año <b>'./*año de impresion*/'</b>';
...
/*TIPO DE LETRA POSICION Y IMPRIMO EL TEXTO*/	
	...
	$pdf->SetFont('Helvetica', '', 10);
	$pdf->SetXY(40, 180);
	$pdf->SetMargins(40, 20, 40, false);
	$pdf->writeHTML($fin, true, 0, true, 0);
/*POSICION Y IMPRIMO EL CODIGO DE BARRAS*/	
	...
	$pdf->output('CONSTANCIA DE EQUIPAJE.pdf', 'F');
?>