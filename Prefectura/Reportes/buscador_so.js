	...
	$.ajax({
		...
		success : function(busqueda){
			...
			for (var i = 0; i<actividades.length-4; i++) {
				...
				$("#tbody").append(
					"<tr><td><img src='../Imagenes/pdf.png' class='img-fluid pdf' style='width: 30px; cursor: pointer' id='"+actividades[i]["tramite_cod"]+"' name='"+actividades[i]["cedula_solicitante"]+"'></td><th>"
					+actividades[i]["tramite_cod"]+"</th><td>"
					+tramite+"</td><td>"
					+texto+"</td><td>"
					+actividades[i]["prefecto"]+"</td><td>"
					+actividades[i]["cedula_solicitante"]+"</td><td>"
					+actividades[i]["estado"]+"</td><td>"
					+actividades[i]["fechat"]+"</td><tr>");
			}
...
$("#l_cedula").change(function(event){
	...
	$.ajax({
		...
		success : function(busqueda){
			...
			for (var i = 0; i<actividades[actividades.length-1]; i++) {
				if (i+1==actividades[actividades.length-2]) {
					$("#paginacion_t").append("<a class='text-dark' href='l_solicitudes.php?pagina="+(i+1)+"&cedula="+actividades[actividades.length-3]+"'><strong>"+(i+1)+" </strong></a>");
				}else{
					$("#paginacion_t").append("<a class='text-dark' href='l_solicitudes.php?pagina="+(i+1)+"&cedula="+actividades[actividades.length-3]+"'>"+(i+1)+" </a>");
				}
			}
			...
			for (var i = 0; i<actividades[actividades.length-1]; i++) {
				if (i+1==actividades[actividades.length-2]) {
					$("#paginacion_b").append("<a class='text-dark' href='l_solicitudes.php?pagina="+(i+1)+"&cedula="+actividades[actividades.length-3]+"'><strong>"+(i+1)+" </strong></a>");
				}else{
					$("#paginacion_b").append("<a class='text-dark' href='l_solicitudes.php?pagina="+(i+1)+"&cedula="+actividades[actividades.length-3]+"'>"+(i+1)+" </a>");
				}
			}
