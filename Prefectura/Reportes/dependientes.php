...
?>
  <script type="text/javascript">
    ...
    <div class="col-lg-10 mx-auto ">
        ...
        <h4 class="text-center mt-3">DEPENDIENTES ECÓNOMICOS REGISTRADOS</h4>
    </div>
    <div class="col-11 m-auto">
        <h5 class="text-primary mt-4">Listado de Dependientes:</h5>
        <form>
            <div class="row justify-content-between mb-2">
                ...
                <div class="col-lg-6 col-md-12 col-sm-10 col-12 mt-1">
                    ...
                    <label class="float-left">Buscar por Dependiente:</label>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-10 col-12 mt-1">
